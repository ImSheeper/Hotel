...
<body>
    <div class="background flex h-screen justify-center items-center">
        <div class="flex bg-white h-auto w-3/4 md:w-84 rounded-lg justify-center">
            <form method="POST" action="{{ route('loginStore') }}" class="flex flex-col w-3/4 overflow overflow-auto">
            @csrf
                ...
                <div class="flex border-b-2 border-solid items-center">
                    <img src="{{url('/icons/User.svg')}}" alt="Image" class="filterGray size-4 ml-2">
                ...
                <div class="flex border-b-2 border-solid items-center">
                    <img src="{{url('/icons/Password.svg')}}" alt="Image" class="filterGray size-4 ml-2">
