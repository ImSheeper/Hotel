        ...
        <div class="flex flex-col h-full w-full ml-1 md:ml-0 overflow-hidden">
            ...
            <div class="flex flex-col bg-white grow mx-1 my-1 mr-2 mb-2 min-w-fit rounded-md overflow-auto items-center">
                ...
                <div class="flex min-h-max w-full justify-center animate-fade-down animate-delay-[1s] animate-ease-out mt-5">
                    <div class="flex flex-col cursor-default min-w-max max-w-[1000px] grow max-h-96 bg-[#F4F2FF] rounded-2xl pl-10 pr-10 pt-5 pb-5 overflow-auto shadow-lg">
                        ...
                        @foreach ($personels as $personel)
                            ...
                            <a href='{{ route('personelParameterRoute', ['login' => $personel->login, 'month' => $month, 'year' => $year]) }}' class="tableClass cursor-pointer grid grid-cols-4 transition-all duration-300 hover:bg-[#dbd5ff] px-2 py-1 rounded-md">
                ...
                <div class="flex min-h-max w-full justify-center animate-fade-down animate-delay-[1s] animate-ease-out items-center mt-5">
                    <div class="flex flex-col cursor-default min-w-max max-w-[1000px] grow max-h-96 bg-[#F4F2FF] rounded-2xl pl-10 pr-10 pt-5 pb-5 overflow-auto shadow-lg">
                        <div class="flex items-center mb-5">
                            <img src={{ url('/icons/Blocked.svg') }} class="z-10 transition duration-500 opacity-100 group-hover:opacity-0 h-6">
                        ...
                        @foreach ($personels as $personel)
                            ...
                            <a href='{{ route('personelParameterRoute', ['login' => $personel->login, 'month' => $month, 'year' => $year]) }}' class="tableClassBlocked cursor-pointer grid grid-cols-2 transition-all duration-300 hover:bg-[#dbd5ff] px-2 py-1 rounded-md">
                                    <div class="className hidden"> {{ $personel->login }} </div>
                                    <div class="class"> {{ $personel->imie }}  {{ $personel->nazwisko }} </div>
                                    <div class="class"> {{ $personel->stanowiska->stanowisko }} </div>
                                </a>
