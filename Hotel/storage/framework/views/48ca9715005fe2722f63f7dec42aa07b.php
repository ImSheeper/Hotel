    ...
    <div class="background flex h-screen overflow-hidden">
                        ...
                        <div class="roomsContainer">
                            <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($room->wykluczone === 0): ?>
                                    ...
                                    <div class="pokoje"> <?php echo e($room->rodzaj->rodzaj); ?> </div>
                            ...
                            <div class="roomsContainerBlocked">
                                <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($room->wykluczone === 1): ?>
                                        <a class="tableClassBlocked cursor-pointer grid grid-cols-6 transition-all duration-300 hover:bg-[#dbd5ff] px-2 py-1 rounded-md" title="<?php echo e($room->powod_wykluczenia); ?>">
                                        <div class="pokoje"> <?php echo e($room->id); ?> </div>
                                        <div class="pokoje"> <?php echo e($room->pietro); ?> </div>
                                        <div class="pokoje"> <?php echo e($room->rodzaj->rodzaj); ?> </div>
                                        <div class="pokoje"> <?php echo e($room->status ? 'Zajęte' : 'Wolne'); ?> </div>
                                        <div class="pokoje"> <?php echo e($room->czyste ? 'Czysty' : 'Brudny'); ?> </div>
                                        <div class="pokoje w-36 overflow-hidden whitespace-nowrap text-ellipsis"> <?php echo e($room->powod_wykluczenia); ?> </div>
                                        </a>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
            ...
            <div class="pop2Personel flex flex-col bg-white w-[500px] min-h-max rounded-lg justify-center p-5">
                    ...
                    <div class="flex justify-center flex-col w-[100%] p-2">
                        ...
                        <?php if($userStanowisko === 'Właściciel Hotelu' || $userStanowisko === 'Menedżer Hotelu'): ?>
                            <select name="Rodzaj" id="Rodzaj" class="data border-2 rounded-lg p-1 w-full bg-white">
                                <?php $__currentLoopData = $rodzaj_pokoj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pokoj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pokoj->id); ?>"> <?php echo e($pokoj->rodzaj); ?> </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>      
                        <?php else: ?>
                ...
                <div class="flex justify-around w-full mt-2">
                    <div class="flex justify-center flex-col w-full p-2">
                        ...
                        <?php if($userStanowisko === 'Właściciel Hotelu' || $userStanowisko === 'Menedżer Hotelu' || $userStanowisko === 'Recepcjonista'): ?>
        ...
        <div class="popDelete bg-black bg-opacity-20 backdrop-blur-sm flex absolute invisible h-full w-full justify-center items-center opacity-0">
            <div class="pop2Delete flex flex-col bg-white w-[500px] min-h-max rounded-lg justify-center p-5">
                ...
                <textarea type="text" placeholder="Powód wykluczenia" class="dataWyklucz border-2 rounded-lg p-1 bg-white mt-5"></textarea> 
        ...
        <script>
            let pokoje = <?php echo json_encode($pokoje, 15, 512) ?>;
            let rodzaj = <?php echo json_encode($rodzaj_pokoj, 15, 512) ?>;
        </script>
    </div>
</body>
</html>
<?php /**PATH C:\Users\patry\Desktop\Hotel\Hotel\Hotel\resources\views/pokoje.blade.php ENDPATH**/ ?>