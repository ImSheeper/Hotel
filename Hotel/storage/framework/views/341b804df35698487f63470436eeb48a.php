    <div class="hidden flex-col h-full w-1/12 md:w-2/12 md:flex overflow-hidden min-w-max">
        ...
        <div class="flex grow over overflow-auto">
            <div class="bg-white grow m-1 ml-2 mb-2 mt-0 rounded-b-md overflow-auto">
                <div class="flex flex-col mt-2">
                    <button class="relative flex h-10 mx-2 my-1 px-4 items-center p-2 text-start group animate-fade-right animate-delay-[0.2s] animate-ease-out">
                    ...
                    <button class="relative flex h-10 mx-2 my-1 px-4 items-center p-2 text-start hover:text-white group animate-fade-right animate-delay-[0.3s] animate-ease-out">
                        ...
                        <div class="p-2 z-10 transition duration-500 group-hover:text-white">Pokoje</div>
                    </button>
                    <button class="relative flex h-10 mx-2 my-1 px-4 items-center p-2 text-start hover:text-white group animate-fade-right animate-delay-[0.4s] animate-ease-out">
                        <div class="absolute rounded-md inset-0 z-0 bg-gradient-to-r opacity-0 transition duration-500 group-hover:opacity-100 from-cyan-400 to-fuchsia-400"></div>
                        ...
                        <div class="p-2 z-10 transition duration-500 group-hover:text-white">Personel</div>
                    </button>
                    <button class="relative flex h-10 mx-2 my-1 px-4 items-center p-2 text-start hover:text-white group animate-fade-right animate-delay-[0.5s] animate-ease-out">
                        <div class="absolute rounded-md inset-0 z-0 bg-gradient-to-r opacity-0 transition duration-500 group-hover:opacity-100 from-cyan-400 to-fuchsia-400"></div>
                    ...
                    <button class="relative flex h-10 mx-2 my-1 px-4 items-center p-2 text-start hover:text-white group animate-fade-right animate-delay-[0.6s] animate-ease-out">
                        <div class="absolute rounded-md inset-0 z-0 bg-gradient-to-r opacity-0 transition duration-500 group-hover:opacity-100 from-cyan-400 to-fuchsia-400"></div>
                    ...
                    <button class="relative flex h-10 mx-2 my-1 px-4 items-center p-2 text-start hover:text-white group animate-fade-right animate-delay-[0.7s] animate-ease-out">
                        <div class="absolute rounded-md inset-0 z-0 bg-gradient-to-r opacity-0 transition duration-500 group-hover:opacity-100 from-cyan-400 to-fuchsia-400"></div>
    ...
    </div><?php /**PATH C:\Users\patry\Desktop\Inzynier\Hotel\resources\views/sidebarTemplate.blade.php ENDPATH**/ ?>