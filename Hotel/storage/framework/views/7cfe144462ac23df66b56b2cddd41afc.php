            ...
            <div class="flex flex-col bg-white grow mx-1 my-1 mr-2 mb-2 min-w-fit rounded-md overflow-auto items-center w-min-max">
                ...
                <div class="flex h-min-max w-full justify-center animate-fade-down animate-delay-[1s] animate-ease-out mt-10 flex-wrap">
                    ...
                    <div class="grid grid-cols-7 z-10">
                        ...
                        <?php if(isset($grafik)): ?>
                            <?php for($i = 0; $i < count($grafik); $i++): ?>
                                <?php $__currentLoopData = $grafik[$i]['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $graf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\patry\Desktop\Hotel\Hotel\resources\views/grafikWhole.blade.php ENDPATH**/ ?>