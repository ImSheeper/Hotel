    ...
    <div class="flex grow over overflow-auto">
        <div class="bg-white grow m-1 ml-2 mb-2 mt-0 rounded-b-md overflow-auto">
            <div class="menu flex flex-col mt-2">
                ...
                <a href='<?php echo e(route('homeRoute')); ?>' class="flex w-full h-10 mb-2">
...
</div><?php /**PATH C:\Users\patry\Desktop\Inzynier\Hotel\resources\views/\Templates\sidebarTemplate.blade.php ENDPATH**/ ?>