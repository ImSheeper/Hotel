...
<body>
    <div class="background flex h-screen justify-center items-center">
        <div class="flex bg-white h-2/4 w-1/4 rounded-lg justify-center">
            <form method="POST" action="<?php echo e(route('loginStore')); ?>" class="flex flex-col w-3/4 overflow overflow-hidden">
            <?php echo csrf_field(); ?>

                <div class="text-3xl font-bold my-14 text-center">Zaloguj się</div>
                ...
                <button class='h-10 mt-14 bg-gradient-to-r from-cyan-400 to-fuchsia-400 text-white font-bold rounded-full onclick:shadow-xl'>ZALOGUJ SIĘ</button>
                <?php if($errors->any()): ?>
                    <div class="text-red-500 text-center mt-5 font-bold">
...
<?php /**PATH C:\Users\patry\Desktop\Inzynier\Hotel\resources\views/welcome.blade.php ENDPATH**/ ?>